...
const stockSummary = [
  { title: 'Total Sales Items', value: 210, icon: <FiCheckCircle className="text-green-500" /> },
  { title: 'Total Return Items', value: 2, icon: <FiRefreshCw className="text-yellow-500" /> },
  { title: 'Total Purchases', value: 500, icon: <FiBox className="text-blue-500" /> },
  { title: 'Purchase Returns', value: 10, icon: <FiAlertTriangle className="text-red-500" /> },
];

const alerts = [
  { product: 'iPad Pro', qty: 5, icon: <FiAlertTriangle className="text-red-500" /> },
  { product: 'DJI Mavic Pro 2', qty: 3, icon: <FiAlertTriangle className="text-red-500" /> },
  { product: 'Google Pixel', qty: 8, icon: <FiAlertTriangle className="text-yellow-500" /> },
];
            ...
            <div className="space-y-3">
              {alerts.map((item, idx) => (
                <div key={idx} className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                  ...
                  <span className="font-bold text-red-600">Only {item.qty} left</span>
                </div>
              ))}
            </div>
          </div>
